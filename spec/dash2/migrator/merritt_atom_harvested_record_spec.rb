  ...
  module Migrator
    describe 'MerrittAtomHarvestedRecord' do
      ...
      before(:each) do
        ...
        # TODO: Figure out why stubbing isn't working (URL encoding? RestClient vs. Net:HTTP weirdness?)
        mrt_mom_uri = 'https://merritt.cdlib.org/d/ark:%2Fc5146%2Fr3rg6g/1/system%2Fmrt-mom.txt'
        stub_request(:get, mrt_mom_uri).to_return(body: File.read('spec/data/mrt-mom.txt'))

        datacite_uri = 'https://merritt.cdlib.org/d/ark:%2Fc5146%2Fr3rg6g/1/producer%2Fmrt-datacite.xml'
