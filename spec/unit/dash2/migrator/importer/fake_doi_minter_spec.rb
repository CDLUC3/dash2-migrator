    ...
    module Importer
      describe FakeDOIMinter do
        ...
        describe '#initialize' do
          it 'raises an exception if invoked in production'
        end
        ...
        describe '#update' do
          ...
          describe 'DOI injection' do
            it 'sets the DOI on the StashWrapper' do
              minter.update(stash_wrapper: stash_wrapper, se_resource: se_resource, dcs_resource: dcs_resource)
          ...
          describe 'migration documentation' do
            ...
            it 'raises an error for previously migrated records' do
              ...
              expect { minter.update(stash_wrapper: stash_wrapper, se_resource: se_resource, dcs_resource: dcs_resource) }.to raise_error(ArgumentError)
            end
          end
        end
      end
